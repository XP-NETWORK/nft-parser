...
class RpcClientCache {
    ...
    getBlockHash({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BLOCK_HASH, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getLiveBlocks({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_LIVE_BLOCKS, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getBalance(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BALANCE, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getStorage(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_STORAGE, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getScript(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateContract(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_SCRIPT, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getNormalizedScript(address, unparsingMode = { unparsing_mode: 'Readable' }, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateContract(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_NORMALIZED_SCRIPT, [
                block,
                address,
                unparsingMode,
            ]);
    ...
    getContract(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateAddress(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_CONTRACT, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getManagerKey(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateAddress(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_MANAGER_KEY, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getDelegate(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateAddress(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_DELEGATE, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getBigMapExpr(id, expr, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BIG_MAP_EXPR, [block, id, expr]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getDelegates(address, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            this.validateAddress(address);
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_DELEGATES, [block, address]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getConstants({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_CONSTANTS, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getBlockHeader({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BLOCK_HEADER, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getBlockMetadata({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BLOCK_METADATA, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getBakingRights(args = {}, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BAKING_RIGHTS, [block, args]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getEndorsingRights(args = {}, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_ENDORSING_RIGHTS, [
                block,
                args,
            ]);
            if (this.has(key)) {
    ...
    getBallotList({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_BALLOT_LIST, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getCurrentQuorum({ block, } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_CURRENT_QUORUM, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getVotesListings({ block, } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_VOTES_LISTINGS, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getProposals({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_PROPOSALS, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getCurrentPeriod({ block, } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_CURRENT_PERIOD, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
    ...
    getSaplingDiffByContract(contract, { block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_SAPLING_DIFF_BY_CONTRACT, [
                block,
                contract,
            ]);
            if (this.has(key)) {
    ...
    getProtocols({ block } = rpc_client_interface_2.defaultRPCOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = this.formatCacheKey(this.rpcClient.getRpcUrl(), rpc_client_interface_1.RPCMethodName.GET_PROTOCOLS, [block]);
            if (this.has(key)) {
                return this.get(key);
            }
            else {
