...
export const tronParser = (collectionIdent, nft, account, whitelisted) => __awaiter(void 0, void 0, void 0, function* () {
    let parsed;
    switch (collectionIdent) {
        case "TGkgcveyPzhzj18dtxpzaAtcL5ZUB8965A": {
            parsed = yield SpaceClub(nft, account, whitelisted);
            break;
        }
        default:
...
export const SpaceClub = (nft, account, whitelisted) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    try {
        const res = yield axios.post(proxy + "https://api.apenft.io/graphql", query, {
            headers: {
                "x-api-key": apenftKey,
...
export const Default = (nft, account, whitelisted) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data } = response;
        const format = yield getAssetFormat(data.image);
        const nft = {
            native,
            chainId,
            tokenId,
