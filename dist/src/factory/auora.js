...
export const auroraParser = (collectionIdent, nft, account, whitelisted, chainId) => __awaiter(void 0, void 0, void 0, function* () {
    let parsed;
    switch (true) {
...
const Virtual = (nft, account, whitelisted) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield axios(`${proxy}https://explorer.mainnet.aurora.dev/token/${collectionIdent}/instance/${tokenId}/metadata`);
