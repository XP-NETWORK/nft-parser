...
const sendTelegramMessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log({ msg });
        let str = `%0Auri: ${msg.uri} %0AchainId: ${msg.native.chainId}%0A<strong>tokenId</strong> ${msg.native.tokenId}%0A%0A<strong>contract</strong> ${msg.native.contract}%0<strong>Aowner</strong> ${msg.native.owner}%0AcontractType ${msg.native.contractType}%0AcollName${msg.native.name}`;
